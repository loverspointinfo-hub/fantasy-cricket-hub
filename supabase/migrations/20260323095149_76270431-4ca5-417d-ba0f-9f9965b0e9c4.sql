...
-- Add name_edit_count to profiles
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS name_edit_count integer NOT NULL DEFAULT 0;

-- Add name_edit_count to user_teams
ALTER TABLE public.user_teams ADD COLUMN IF NOT EXISTS name_edit_count integer NOT NULL DEFAULT 0;
